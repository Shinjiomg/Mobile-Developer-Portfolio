    ...
    <footer class="bg-neutral-900/80 py-8 backdrop-blur-md border-t border-blue-800/30">
      <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block text-lg font-bold text-blue-400">Desarrollador Android Junior</span>
            <span class="block text-xs text-gray-500 mt-1">📍 Bogotá, Colombia</span>
            <span class="block text-xs text-gray-500 mt-1">📞 +57 317-467-0048</span>
            <span class="block text-xs text-gray-500 mt-1">📧 juanpablion1600@gmail.com</span>
          </div>
        ...
        <div class="flex flex-col items-center gap-3">
          ...
          <span class="text-xs text-blue-400 mt-2">Disponible para trabajar inmediamente</span>
        </div>
        <div class="flex flex-col items-center gap-3">
          <div class="flex gap-4">
            <a href="https://github.com/JuanPCFdev" target="_blank" rel="noopener noreferrer" class="group relative text-gray-400 hover:text-blue-400 transition-colors" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/juancuellar-dev/" target="_blank" rel="noopener noreferrer" class="group relative text-gray-400 hover:text-blue-400 transition-colors" aria-label="LinkedIn">

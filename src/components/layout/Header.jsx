                    ...
                    <nav class="flex-1 flex items-center gap-6 justify-center">
                        {links.map((link) => (
                            <a 
                                data-scroll 
                                href={link.href} 
                                class={`flex items-center gap-2 text-gray-100 hover:text-blue-500 transition-colors md:text-sm 2xl:text-base hover:scale-105 duration-300 hover:bg-blue-500/10 rounded-full px-3 py-1 2xl:px-3 2xl:py-2 ${
                                    activeTab() === link.href.substring(1) ? "text-blue-500 bg-blue-500/10" : ""
                                }`}
                            >
                                <link.icon />
                                {link.name}
